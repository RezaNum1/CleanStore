...
class ShowOrderViewController: UIViewController, ShowOrderDisplayLogic
{
  ...
  func displayOrder(viewModel: ShowOrder.GetOrder.ViewModel) {
    ...
    orderIDLabel.text = displayOrder.id
    orderDateLabel.text = displayOrder.date
    orderEmailLabel.text = displayOrder.email
    orderNameLabel.text = displayOrder.name
    orderTotalLabel.text = displayOrder.total
  }
}
